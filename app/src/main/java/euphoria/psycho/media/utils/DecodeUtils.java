...
import euphoria.psycho.common.ThreadPool.CancelListener;
...
public class DecodeUtils {
    ...
    public static Bitmap decodeUsingPool(JobContext jc, byte[] data, int offset,
        ...
        try {
            ...
            if (options.inBitmap != null && options.inBitmap != bitmap) {
                TiledScreenNail.GalleryBitmapPool.getInstance().put(options.inBitmap);
    ...
    private static Bitmap findCachedBitmap(JobContext jc, byte[] data,
        ...
        return TiledScreenNail.GalleryBitmapPool.getInstance().get(options.outWidth, options.outHeight);
    }
